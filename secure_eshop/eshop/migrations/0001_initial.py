    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', eshop.utils.fields.EncryptedCharField(blank=True, help_text='Email address (encrypted)', max_length=2286, verbose_name='email address')),
                ('first_name', eshop.utils.fields.EncryptedCharField(blank=True, help_text='First name (encrypted)', max_length=1350, verbose_name='first name')),
                ('last_name', eshop.utils.fields.EncryptedCharField(blank=True, help_text='Last name (encrypted)', max_length=1350, verbose_name='last name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', eshop.utils.fields.EncryptedCharField(max_length=1800, verbose_name='Διεύθυνση')),
                ...
                ('email', eshop.utils.fields.EncryptedCharField(help_text='Απαιτείται για επικοινωνία σχετικά με την παραγγελία', max_length=2286, null=True, verbose_name='Email')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
